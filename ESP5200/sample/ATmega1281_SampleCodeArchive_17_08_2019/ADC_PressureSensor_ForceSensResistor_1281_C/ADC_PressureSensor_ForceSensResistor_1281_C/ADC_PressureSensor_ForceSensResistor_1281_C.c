//*****************************************
// Project		ADC Pressure Sensor Demonstration (ADC using Interrupts) (Embedded C)
// Target		ATmega1281 on STK300
// Program		ADC_PressureSensor_ForceSensResistor_1281_C.c
// Author		Richard Anthony
// Date			2nd November 2013

// Function		Demonstrates:	ADC operation
//								Use of Interrupts
//								Use of Force Sensing Resistor (FSR)

//					Reads ADC channel 0 (Port F bit 0)
...
// I/O hardware	Uses custom-built Pressure Sensor (Force Sensing Resistor type) analog input sensor on Port F
//					(Pressure sensor is connected as part of voltage divider across GND and VCC)	
//					The Pressure sensor is a negative temperature coefficient device, so resistance
//					falls as pressure rises. The pressure sensor is connected as the +ve side of
//					the voltage divider so that the voltage, and thus ADC output value, rises
//					the pressure rises.
//					Typical digital values (as decimal)
//					Force (grammes)		ADC 8-bit reading
//					0					41
//					100					45
//					200					51
//					300					90
...
//					The pressure sensor output voltage spans the entire ADC Minimum to FSD 
...
void Initialise_ADC()
{
	...
	ADMUX = 0b01100000;		// Use AVCC as voltage ref, Convert channel 0 (Pressure sensor connected to bit 0)
