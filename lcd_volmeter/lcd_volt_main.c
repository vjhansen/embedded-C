...
volatile unsigned int milli_volt;		// - Global variable holding the voltage value
volatile unsigned int potmeter_inn;		// - Global variable holding ADCW.
...
int main() 
{
	...
	/***********************/
	DDRC   = 0xF7;		// - PINC.3 pulled low via 1k ohm resistor --- 0b11110111
